  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      ...
      <div class="side_bar">
        ...
        <div class="filters">
          <a href='./declare_abc.php'>Αλφαβητικά</a>
        </div>
        <div class="filters">
        <a href='./declare_desc.php'>Δημοτικότητα (φθίνουσα)</a>
        </div>
        <div class="filters">
        <a class="active" href='./declare_asc.php'>Δημοτικότητα (αύξουσα)</a>
        </div>
      </div>
            ...
            <div class="column">
              <div class="card">
                ...
                <img src="../images/cover59366672.jpg" alt="cover59366672" style="width:100%">
            		...
            		<div class="book-title"><?php echo $arb[$x]; ?></div>
